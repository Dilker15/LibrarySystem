...
export class CreateBookDto{
    ...
    static generate(body:{[key:string]:any}):CreateBookDto{
        return new CreateBookDto(body.isbn,body.name,body.description,body.image,body.category_id,body.authors);
    }
}